...
- _return value_ [`Number`] berupa sebuah `array` baru yang sudah terbalik
...
- _return value_ [`Number`] total angka yang melebihi nilai rata-rata
...
- Peserta memahami cara penggunaan _built-in function_ dari `array`
